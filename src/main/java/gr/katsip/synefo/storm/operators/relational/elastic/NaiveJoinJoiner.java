 ...
 */
public class NaiveJoinJoiner implements AbstractJoinOperator, Serializable {
    ...
    private NaiveWindowJoin naiveWindowJoin;
     ...
     * @param storedRelationSchema
     * @param otherRelation
     * @param otherRelationSchema
     * @param storedJoinAttribute
     * @param otherJoinAttribute
     * @param window window-size in seconds
     * @param slide slide size in seconds
     */
    public NaiveJoinJoiner(String storedRelation, Fields storedRelationSchema, String otherRelation,
        ...
        this.slide = slide;
        naiveWindowJoin = new NaiveWindowJoin(windowSize, slide, storedRelationSchema, storedJoinAttribute,
                storedRelation, otherRelation);
    }
    ...
    public int execute(Tuple anchor, OutputCollector collector,
        ...
        if(Arrays.equals(attributeNames.toList().toArray(), storedRelationSchema.toList().toArray())) {
             ...
             * Store the new tuple
             */
            naiveWindowJoin.insert(currentTimestamp, attributeValues);
             ...
             */
            List<Values> joinResult = naiveWindowJoin.join(currentTimestamp, attributeValues, attributeNames, otherJoinAttribute);
...
//        state.add(slidingWindowJoin);
    ...
    public long getStateSize() {
        return naiveWindowJoin.getStateSize();
    }
