							...
							if(thresholds.containsKey(resourceName)) {
								...
								if(resourceBound.equals("min")) {
									if(resourceName.equals("cpu") || resourceName.equals("memory")) {
										values.first = new Double(Double.parseDouble(resource_val));
									}else {
										values.first = new Integer(Integer.parseInt(resource_val));
									}
								}else {
									if(resourceName.equals("cpu") || resourceName.equals("memory")) {
										values.second = new Double(Double.parseDouble(resource_val));
									}else {
										values.second = new Integer(Integer.parseInt(resource_val));
									}
								}
