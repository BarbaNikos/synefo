...
/**
 * Created by katsip on 9/4/2015.
 */
public class GeneralMetricOvertimeVisualizer {
    public static void main(String[] args) throws IOException {
        HashMap<String, List<Integer>> taskNameToIdentifiersMap = new HashMap<>();
        HashMap<Integer, HashMap<String, List<String>>> taskIdentifierToMetricsMap = new HashMap<>();
        String[] metrics = null;
        ...
        if(directory.isDirectory()) {
                ...
                if(machineDirectory.isDirectory()) {
                    ...
                    for (File metricLog : metricLogs) {
                        ...
                        while ((line = reader.readLine()) != null) {
                             ...
                             */
                            HashMap<String, List<String>> metricToValuesMap = null;
            ...
            while(taskNameIterator.hasNext()) {
                ...
                for(Integer task : taskIdentifiers) {
                    HashMap<String, List<String>> taskMetrics = taskIdentifierToMetricsMap.get(task);
                    Iterator<Map.Entry<String, List<String>>> metricIterator = taskMetrics.entrySet().iterator();
                    while (metricIterator.hasNext()) {
                        Map.Entry<String, List<String>> pair = metricIterator.next();
                        /**
                        ...
                        Integer count = 0;
                        for(String point : pair.getValue()) {
