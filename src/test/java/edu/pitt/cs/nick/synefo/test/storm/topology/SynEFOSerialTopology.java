...
//import gr.katsip.synefo.storm.operators.SampleOperator;
...
//
//public class SynEFOSerialTopology {
//
...
//		 * Stage 1
//		 */
//		builder.setBolt("bolt_1", new SynEFOBolt("bolt_1", synEFO_ip, synEFO_port, new SampleOperator(), 10), 1).directGrouping("spout_1");
//		_tmp.add("bolt_3");
...
//		 * Stage 2
//		 */
//		builder.setBolt("bolt_3", new SynEFOBolt("bolt_3", synEFO_ip, synEFO_port, new SampleOperator(), 10), 1).directGrouping("bolt_1");
//		_tmp = null;
//		_topology._topology.put("bolt_3", new ArrayList<String>());
//		_tmp = new ArrayList<String>();
//		_tmp.add(Integer.toString(3));
