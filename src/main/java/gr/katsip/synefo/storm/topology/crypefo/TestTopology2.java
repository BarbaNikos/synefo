...
public class TestTopology2{
	...
	InterruptedException, ClassNotFoundException, AlreadyAliveException, InvalidTopologyException {
		...
		returnSet.add(1);
		returnSet.add(2);
		Select selectOperator = new Select(returnSet, "50", 1, 0, 0, 1000, "select_bolt_1a", zooIP, zooPort);
		...
		selectOperator = new Select(returnSet, "50", 1, 0, 0, 1000, "select_bolt_1b", zooIP, zooPort);
		selectOperator.setOutputSchema(new Fields(selectionOutputSchema));
		...
		selectOperator = new Select(returnSet, "50", 1, 0, 1, 1000, "select_bolt_2a", zooIP, zooPort);
		selectOperator.setOutputSchema(new Fields(selectionOutputSchema));
		...
		selectOperator = new Select(returnSet, "50", 1, 0, 1, 1000, "select_bolt_2b", zooIP, zooPort);
		selectOperator.setOutputSchema(new Fields(selectionOutputSchema));
		...
		cluster.submitTopology("debug-topology-2", conf, builder.createTopology());
		Thread.sleep(200000);
	}
}
