...
public class SynEFOTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		_topology._topology.put("filter_bolt_1", new ArrayList<String>(_tmp));
		...
		_topology._topology.put("filter_bolt_2", new ArrayList<String>(_tmp));
		_tmp = null;
		/**
		 * Stage 2
		 */
		...
		_topology._topology.put("join_bolt_3", new ArrayList<String>());
		_tmp = null;
		_tmp = new ArrayList<String>();
		/**
